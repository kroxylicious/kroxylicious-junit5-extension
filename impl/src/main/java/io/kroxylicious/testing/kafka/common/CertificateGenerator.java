...
public class CertificateGenerator {
     ...
     */
    public CertificateGenerator(String domain) {
        this(domain, null);
    }

    /**
     * Instantiates a new Certificate generator.
     * This constructor gives the possibility to add a domain as a SAN dns and
     * an IP address as a SAN IP.
     *
     * @param domain the domain
     * @param ipAddress the ip address
     */
    public CertificateGenerator(String domain, String ipAddress) {
        this.domain = domain;
