...
* [#669](https://github.com/kroxylicious/kroxylicious-junit5-extension/issues/669): change: Move `junit-jupiter-api` to `provided` scope in impl and junit5-extension modules
